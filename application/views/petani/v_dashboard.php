...
<div class="main-content">
    ...
    <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
        <div>
            ...
            <p class="subtitle mb-0 mt-1">Selamat datang, Petani! <span id="currentDateTime" style="color: var(--amber-cream); font-weight:500;"></span></p>
        </div>
                    ...
                    <?php foreach($top_products as $index => $product): ?>
                        <div class="d-flex align-items-center justify-content-between py-2 <?= $index < 4 ? 'border-bottom' : ''; ?>" style="border-color: rgba(74,44,17,0.05);">
                            ...
                            <div class="text-right">
                                ...
                                <small class="d-block text-muted" style="font-size:0.7rem;"><?= $product['pendapatan']; ?></small>
                            </div>
                        </div>
                    <?php endforeach; ?>
                </div>
                            ...
                            <tbody>
                                ...
                                <?php foreach($recent_orders as $order): ?>
                                    <tr>
                                        ...
                                        <td><?= $order['produk']; ?></td>
                                        <td><span class="badge" style="background: var(--bg-cream); color: var(--dark-coffee);"><?= $order['qty']; ?></span></td>
                                        <td>
        ...
        <div class="col-lg-6 mb-4">
            <div class="custom-card">
                <div class="card-header-custom">
                    ...
                    <span class="badge" style="background: #DBEAFE; color: #1E40AF; font-weight:500;">Minggu ini</span>
                </div>
                <div class="card-body-custom">
                    ...
                    <?php foreach($harvest_schedule as $schedule): ?>
                        <div class="harvest-schedule-item">
                            ...
                            <span class="badge" style="background: var(--amber-cream); color: white; padding: 4px 12px; border-radius:20px; font-weight:500;">
                                Siap Panen
                            </span>
                        </div>
                    <?php endforeach; ?>
                    ...
                    <div class="row">
                        <div class="col-md-6 col-6 mb-2">
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label" for="notifPesanan" style="font-size:0.85rem;">Pesanan Baru</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-6 mb-2">
                            <div class="custom-control custom-switch">
                        ...
                        <div class="col-md-6 col-6 mb-2">
                            <div class="custom-control custom-switch">
                                ...
                                <label class="custom-control-label" for="notifPanen" style="font-size:0.85rem;">Jadwal Panen</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-6 mb-2">
                            <div class="custom-control custom-switch">
                                <input type="checkbox" class="custom-control-input" id="notifKurir" checked>
                                <label class="custom-control-label" for="notifKurir" style="font-size:0.85rem;">Status Kiriman</label>
                            </div>
                        </div>
                        <div class="col-md-6 col-6 mb-2">
                            <div class="custom-control custom-switch">
