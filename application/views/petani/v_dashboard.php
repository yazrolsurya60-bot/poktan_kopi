	...
	<div class="main-content">
		...
		<div class="page-header d-flex justify-content-between align-items-center flex-wrap">
			<div>
				...
				<p class="subtitle mb-0 mt-1">Selamat datang, <span style="color: var(--amber-cream); font-weight:600;">Petani Kopi</span>!
				...
				<div style="position: relative;">
					...
					<div class="notif-dropdown" id="notifDropdown">
						<div class="notif-dropdown-header">
							...
							<a href="<?= base_url('petani/dashboard/history'); ?>" style="font-size:0.75rem; color: var(--amber-cream); font-weight:500; text-decoration:none;">Lihat Semua</a>
						</div>
							...
							<table class="table table-custom mb-0">
								...
								<tbody>
									<tr>
										...
										<td><span class="badge"
												style="background: var(--bg-cream); color: var(--dark-coffee);">50 kg</span></td>
									...
									<tr>
										...
										<td><span class="badge"
												style="background: var(--bg-cream); color: var(--dark-coffee);">25 kg</span></td>
									...
									<tr>
										...
										<td><span class="badge"
												style="background: var(--bg-cream); color: var(--dark-coffee);">40 kg</span></td>
									...
									<tr>
										...
										<td><span class="badge"
												style="background: var(--bg-cream); color: var(--dark-coffee);">15 kg</span></td>
							...
							<div class="row">
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_transaksi" name="notif_transaksi" checked>
								...
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_pembayaran" name="notif_pembayaran" checked>
								...
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_stok" name="notif_stok" checked>
								...
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_kurir" name="notif_kurir" checked>
								...
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_panen" name="notif_panen" checked>
								...
								<div class="col-md-6 col-6 mb-2">
									<div class="custom-control custom-switch">
										<input type="checkbox" class="custom-control-input" id="notif_sistem" name="notif_sistem" checked>
