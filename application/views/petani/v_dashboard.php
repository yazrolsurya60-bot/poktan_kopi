            ...
            <div class="row mb-4">
                ...
                <div class="col-xl-3 col-md-6 mb-4">
                    <div class="stat-box">
                        ...
                        <h3 class="stat-num">Rp <?= number_format($kpi_omset_penjualan ?? 43750000, 0, ',', '.'); ?>
                        </h3>
                        <div class="stat-change up"><i class="bi bi-arrow-up"></i> 8.7% dari bulan lalu</div>
                        <div class="stat-badge" style="background: #059669; color: white;"><i
                    ...
                    <div class="custom-card">
                        ...
                        <div class="card-body-custom">
                            ...
                            <div class="mt-3 pt-2 border-top" style="border-color: rgba(74,44,17,0.06);">
                                ...
                                <button class="btn btn-link text-muted" style="font-size:0.85rem;"
                                    onclick="markAllRead()">
