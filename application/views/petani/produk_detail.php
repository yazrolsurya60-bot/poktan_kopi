...
<head>
    ...
    <title>Detail Produk - Petani Kopi</title>
            ...
            <div>
                ...
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb breadcrumb-custom">
                        <li class="breadcrumb-item"><a href="<?= base_url('petani/dashboard'); ?>">Dashboard</a></li>
                        <li class="breadcrumb-item"><a href="<?= base_url('petani/produk'); ?>">Katalog Produk</a></li>
                        <li class="breadcrumb-item active" aria-current="page"><?= isset($produk) ? $produk->nama_produk : 'Detail'; ?></li>
                    </ol>
                </nav>
            </div>
        ...
        <div class="detail-card">
            <div class="card-header-custom">
                ...
                <div class="d-flex gap-2" style="gap: 8px;">
                    ...
                    <a href="<?= base_url('petani/produk/hapus/' . (isset($produk) ? $produk->id_produk : '')); ?>" class="btn-delete-detail"
