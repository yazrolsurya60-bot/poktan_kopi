                    ...
                    <div class="card-body d-flex align-items-center justify-content-between p-3">
                        <div>
                            ...
                            <h2 class="font-weight-bold text-dark mb-0">
                                ...
                                $aktif = 0;
                                foreach ($lahan as $lh) {
                                    if (strtolower($lh['status_lahan']) == 'active' || $lh['status_lahan'] == 'aktif')
                                        $aktif++;
                                }
                                echo $aktif;
                                ?>
                    ...
                    <div class="card-body d-flex align-items-center justify-content-between p-3">
                        <div>
                            ...
                            <h2 class="font-weight-bold text-dark mb-0">
                                ...
                                $nonaktif = 0;
                                foreach ($lahan as $lh) {
                                    if (strtolower($lh['status_lahan']) == 'inactive' || $lh['status_lahan'] == 'nonaktif')
                                        $nonaktif++;
                                }
                                echo $nonaktif;
                                ?>
                            ...
                            <div class="form-row">
                                ...
                                <div class="col-12 col-sm-4 mb-2 mb-sm-0">
                                    <select name="status_lahan" class="form-control form-control-sm bg-light border-0"
                                        ...
                                        <option value="Active" <?= $this->input->get('status_lahan') == 'Active' ? 'selected' : ''; ?>>
                                            Active</option>
                                        <option value="Inactive" <?= $this->input->get('status_lahan') == 'Inactive' ? 'selected' : ''; ?>>
                                            Inactive</option>
                                    </select>
                                </div>
                            ...
                            foreach ($lahan as $lh): ?>
                                <tr>
                                    ...
                                    <td class="align-middle text-muted small">
                                        <?= isset($lh['lokasi']) ? character_limiter($lh['lokasi'], 45) : '-'; ?>
                                    </td>
