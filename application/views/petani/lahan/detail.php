...
<div class="detail-container">
    ...
    <div class="info-grid">
        <div><span class="label-text">Jenis Kopi</span><span class="value-text"><?= $lahan['jenis_kopi'] ?></span></div>
        <div><span class="label-text">Luas Lahan</span><span class="value-text"><?= $lahan['luas'] ?> Ha</span></div>
