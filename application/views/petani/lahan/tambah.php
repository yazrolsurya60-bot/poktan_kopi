...
<body>
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-between align-items-center mb-4">
            <div>
                ...
                <h3 class="font-weight-bold text-coffee-primary d-inline-block align-middle mb-1"
                    style="letter-spacing: -0.5px;">Tambah Lahan</h3>
                <p class="text-muted small mb-0">Dashboard / Kelola Lahan / Tambah</p>
            </div>
            <div>
        ...
        <div class="card custom-card p-4">
            <h5 class="fw-bold mb-4" style="color: #4A2C11; border-bottom: 2px solid #f0e6dd; padding-bottom: 15px;">Form Data Lahan Baru</h5>
            <form action="<?= base_url('petani/lahan/tambah') ?>" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <input type="text" name="nama_lahan" class="form-control form-control-custom"
                                placeholder="Contoh: Kebun Kopi Sumber Makmur" required>
                        </div>
                        <div class="form-group mb-3">
                        ...
                        <div class="form-group mb-3">
                            ...
                            <div class="custom-file mb-2">
                                ...
                                <label class="custom-file-label form-control-custom" for="fotoLahan" style="padding-top: 10px; height: 48px;">Pilih file foto...</label>
                            </div>
                        ...
                        <div class="form-group mb-3">
                            ...
                            <textarea name="catatan" class="form-control form-control-custom" rows="3"
                                placeholder="Masukkan catatan tambahan perawatan jika ada"></textarea>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="form-group mb-3">
                            ...
                            <textarea name="lokasi" class="form-control form-control-custom" rows="2"
                                placeholder="Masukkan alamat lengkap lahan" required></textarea>
                        </div>
                        <div class="form-group mb-3">
                            <label class="form-label-custom">Titik Peta Lokasi (Leaflet JS) *</label>
                            <div id="map"></div>
                            <div class="map-instruction fw-bold"><i class="fas fa-hand-pointer mr-1"></i> Klik pada peta untuk menandai koordinat lahan Anda.</div>
                        </div>
                        <div class="form-row">
                ...
                <div class="d-flex justify-content-end">
                    ...
                    <button type="submit" class="btn btn-save"><i class="fas fa-save mr-1"></i> Simpan Data Lahan</button>
                </div>
            </form>
        </div>
    </div>
