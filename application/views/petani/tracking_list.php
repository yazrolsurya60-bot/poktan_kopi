        ...
        <div class="col-12">
            <div class="card">
                <div class="card-header">
                    <h4><i class="bi bi-pencil-square"></i> Update Status Pengiriman</h4>
                </div>
                <div class="card-body">
                    ...
                    <?php else: ?>
                        <div class="table-responsive">
                            <table class="table table-hover">
                                <thead><tr><th>Invoice</th><th>Pembeli</th><th>Status</th><th>Kurir</th><th>Terakhir Update</th><th>Aksi</th></tr></thead>
                                <tbody>
                                    <?php foreach ($trackings as $track): ?>
                                        <tr>
                                            ...
                                            <td><a href="<?= base_url('petani/tracking/update/' . $track->id_tracking) ?>" class="btn btn-primary btn-sm" style="background: var(--roasted-brown, #4A2C11); border: none; border-radius:8px;"><i class="bi bi-pencil"></i> Update</a></td>
                                        </tr>
                                    <?php endforeach; ?>
                                </tbody>
                            </table>
