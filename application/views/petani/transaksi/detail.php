...
<head>
    ...
    <title>Detail Transaksi - Petani Kopi</title>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="subtitle mb-0 mt-1">Informasi lengkap pesanan produk Anda</p>
            </div>
    ...
    <script>
        ...
        console.log('✅ Halaman Detail Transaksi Petani siap digunakan!');
    </script>
