...
<body>
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h2 class="d-inline-block align-middle mb-0">
                    <i class="bi bi-pencil-square" style="color: var(--amber-cream);"></i> Edit Produk
                </h2>
                <p class="subtitle mb-0 mt-1">
                    Edit spesifikasi produk kopi yang sudah ada di katalog
                </p>
            </div>
                        ...
                        <div class="col-lg-6">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="proses" id="proses" class="form-control" 
                                       ...
                                       value="<?= isset($produk) ? ($produk->proses ?? '') : ''; ?>" readonly>
                            </div>

                            <!-- HARGA - Auto fill dari Admin (readonly) -->
                            <div class="form-group">
                                <label>Harga (Rp) / Kg</label>
                                <input type="number" name="harga" id="harga" class="form-control" 
                                       placeholder="Otomatis terisi" 
                                       value="<?= isset($produk) ? $produk->harga : ''; ?>" readonly>
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="stok_produk" id="stok" class="form-control"
                                    placeholder="Contoh: 50" value="<?= isset($produk) ? $produk->stok_produk : ''; ?>" required>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" name="total" id="total" class="form-control" 
                                       style="font-weight:700; color:var(--roasted-brown);" readonly
                                       value="<?php 
                                       if (isset($produk)) {
                        ...
                        <div class="col-lg-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="altitude" class="form-control"
                                    placeholder="Contoh: 900 Meter" value="<?= isset($produk) ? $produk->altitude : ''; ?>">
                            </div>
    ...
    <script>
        ...
        console.log('✅ Form Edit Produk Petani siap digunakan!');
