			...
			<ul class="sidebar-menu">
				...
				<li class="menu-item">
					<a href="<?= base_url('petani/lahan'); ?>">
						<i class="bi bi-people-fill"></i>Kelola Lahan
						<span class="menu-badge">12</span>
					</a>
				</li>
				<li class="menu-item">
					<a href="<?= base_url('petani/panen'); ?>">
						<i class="bi bi-person-badge-fill"></i>Manajemen Panen
					</a>
				</li>
				<li class="menu-item active">
					<a href="<?= base_url('petani/produk'); ?>">
						<i class="bi bi-map-fill"></i>Katalog Produk
					</a>
				</li>
				<li class="menu-item">
					<a href="<?= base_url('petani/transaksi'); ?>">
						<i class="bi bi-tree-fill"></i>Pesanan Masuk
					</a>
				</li>
				<li class="menu-item">
					<a href="<?= base_url('petani/tracking'); ?>">
						<i class="bi bi-box-seam-fill"></i>Tracking Kiriman
					</a>
				</li>
				<li class="menu-item">
