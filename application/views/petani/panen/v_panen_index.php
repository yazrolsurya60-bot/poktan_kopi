...
<body>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item">
                    <a href="<?= base_url('petani/lahan'); ?>">
                        ...
                        <span class="menu-badge"
                            style="margin-left: auto; background: rgba(230, 161, 92, 0.2); color: #E6A15C; font-size: 0.7rem; padding: 2px 10px; border-radius: 20px; font-weight: 600;">3</span>
                    </a>
                </li>
                ...
                <li class="menu-item">
                    <a href="<?= base_url('petani/produk'); ?>">
                        ...
                        <span class="menu-badge"
                            style="margin-left: auto; background: rgba(230, 161, 92, 0.2); color: #E6A15C; font-size: 0.7rem; padding: 2px 10px; border-radius: 20px; font-weight: 600;">5</span>
                    </a>
                </li>
                <li class="menu-item">
                    <a href="<?= base_url('petani/transaksi'); ?>">
                        ...
                        <span class="menu-badge"
                            style="margin-left: auto; background: rgba(230, 161, 92, 0.2); color: #E6A15C; font-size: 0.7rem; padding: 2px 10px; border-radius: 20px; font-weight: 600;">8</span>
                    </a>
                </li>
                <li class="menu-item">
    ...
    <div class="main-content">
        ...
        <div class="d-flex justify-content-end mb-3 gap-2">
            <a href="<?= base_url('petani/panen/tambah'); ?>" class="btn btn-custom btn-custom-primary">
                            ...
                            <?php else: ?>
                                ...
                                foreach ($panen_list as $p): ?>
                                    <tr>
                                        ...
                                        <td class="font-weight-bold"><?= number_format($p['jumlah_panen'], 0, ',', '.'); ?> Kg
                                        </td>
                                        <td><span class="badge badge-light"
                                                style="font-size:0.75rem; border:1px solid #ccc;"><?= htmlspecialchars($p['kualitas'] ?? '-'); ?></span>
                                        </td>
                                        <td class="text-center d-print-none">
                                            <a href="<?= base_url('petani/panen/detail/' . $p['id_panen']); ?>"
                                                class="btn btn-custom btn-custom-info" title="Detail">
                                                <i class="bi bi-eye"></i>
                                            </a>
