...
<body>
            ...
            <ul class="sidebar-menu">
                ...
                <li class="menu-item">
                    <a href="<?= base_url('petani/transaksi'); ?>">
                        ...
                        <span class="menu-badge danger">8</span>
                    </a>
                </li>
    ...
    <div class="main-content">
        <div class="page-header">
            <div>
                ...
                <p class="subtitle mb-0 mt-1">Kelola data hasil panen kopi Anda.</p>
            </div>
    ...
    <script>
        ...
        document.addEventListener('click', function(e) {
            ...
            if (!sidebarMenu.contains(e.target) && sidebarToggle && !sidebarToggle.contains(e.target)) {
        ...
        console.log('✅ Halaman Manajemen Panen siap digunakan!');
    </script>
</body>
