...
<head>
    ...
    <title>Detail Panen - Petani</title>
    ...
    <style>
        ...
        .sidebar { width: var(--sidebar-width); height: 100vh; position: fixed; top: 0; left: 0; background: linear-gradient(180deg, var(--dark-coffee) 0%, #1a0e04 100%); color: var(--bg-cream); display: flex; flex-direction: column; }
...
<div class="main-content">
    <div class="page-header d-flex justify-content-between align-items-center">
        <div>
            ...
            <p class="subtitle mb-0 mt-1">Informasi lengkap hasil panen (M04-F03).</p>
        </div>
        <div>
            <a href="<?= base_url('petani/panen'); ?>" class="btn btn-custom btn-secondary" style="background:#E5E7EB; border:none; color:#4B5563;"><i class="bi bi-arrow-left"></i> Kembali</a>
        </div>
    </div>

    <div class="custom-card">
        <div class="card-header-custom">
            <i class="bi bi-info-circle mr-2 text-warning"></i>Informasi Panen
        </div>
