...
<head>
    ...
    <style>
        ...
        .summary-row .value { font-weight: 700; color: var(--roasted-brown); }
        .summary-row.total .value { color: var(--dark-coffee); font-size: 1.2rem; }
    ...
    <div class="container">
        ...
        <div class="row">
            ...
            <div class="col-lg-8 mb-4">
                            ...
                            <tbody id="cart-body">
                                ...
                                <tr id="cart-row-<?= $item['id_keranjang']; ?>">
                                        ...
                                        <div class="d-flex align-items-center" style="gap: 14px;">
                                            ...
                                            <div>
                                                ...
                                                <div class="product-farmer">
                                                    <i class="bi bi-person-fill mr-1"></i>oleh <?= $item['nama_petani']; ?>
                                                </div>
                                            </div>
                                        </div>
                                    </td>
                                    ...
                                    <td class="text-center">
                                        <span class="price-text">Rp <?= number_format($item['harga_satuan'], 0, ',', '.'); ?></span>
                                    </td>
                                    <!-- Jumlah -->
                                    <td class="text-center">
                                        <div class="qty-control">
                                            <button class="qty-btn btn-qty"
                ...
                <!-- Lanjutkan Belanja -->
                <div class="mt-3">
                    <a href="<?= base_url('produk'); ?>" class="btn-lanjut" style="width: auto; display: inline-block; padding: 10px 24px;">
            ...
            <div class="col-lg-4">
                <div class="summary-card">
                    ...
                    <div class="summary-row">
                        ...
                        <span class="value" id="total_keranjang_summary">Rp <?= number_format($total_harga, 0, ',', '.'); ?></span>
                    </div>
                    <div class="summary-row">
                        <span class="label">Ongkir</span>
                        <span class="value" style="color: var(--text-secondary); font-weight: 500;">Dihitung saat checkout</span>
                    </div>
                    <div class="summary-row total">
                        <span>Total</span>
                        <span class="value" id="total_keranjang">Rp <?= number_format($total_harga, 0, ',', '.'); ?></span>
                    </div>
...
$(document).ready(function () {
    ...
    $('.qty-input').on('change', function () {
        ...
        if (qty < 1) qty = 1;
        if (qty > max) { alert('Stok tidak mencukupi'); qty = max; }
        $(this).val(qty);
        updateCart(id, qty);
    });
    ...
    $('.btn-qty').on('click', function () {
        ...
        if (action === 'plus') {
            if (qty >= max) { alert('Stok tidak mencukupi'); return; }
            qty++;
        } else {
            if (qty <= 1) return;
            qty--;
