                ...
                <li class="menu-item">
                    <a href="<?= base_url('admin/user'); ?>">
                        ...
                        <span class="menu-badge"
                            style="margin-left: auto; background: rgba(230, 161, 92, 0.2); color: #E6A15C; font-size: 0.7rem; padding: 2px 10px; border-radius: 20px; font-weight: 600;">12</span>
                    </a>
                </li>
                <li class="menu-item">
        ...
        <div class="custom-card mb-4 d-print-none">
            <div class="card-body-custom" style="padding: 16px 24px;">
                <form method="GET" action="<?= base_url('admin/panen'); ?>" class="row align-items-end">
                    ...
                    <div class="col-md-3">
                        <button type="submit" class="btn btn-sm btn-custom btn-secondary-custom w-100 mt-2"
                            style="background:#E5E7EB; color:#4B5563; border:none; border-radius:8px; padding:6px;">Terapkan
                            Filter</button>
                    </div>
                </form>
            </div>
