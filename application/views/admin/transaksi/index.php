    ...
    <div class="sidebar" id="sidebarMenu">
        ...
        <div class="sidebar-menu-wrapper">
            <ul class="sidebar-menu">
                ...
                <li class="menu-item active"><a href="<?= base_url('admin/transaksi'); ?>"><i class="bi bi-wallet2"></i>Transaksi <span class="menu-badge"><?= count($transaksi ?? []); ?></span></a></li>
    ...
    <div class="main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="subtitle mb-0 mt-1">Kelola semua transaksi yang terjadi di platform dengan mudah</p>
            </div>
        ...
        <div class="row mb-4 fade-in">
            <div class="col-12">
                <div class="d-flex gap-2 flex-wrap">
                    ...
                    <a href="#" class="quick-action-btn btn-print" onclick="window.print(); return false;">
        ...
        <div class="row mb-4">
            <div class="col-lg-3 col-6 mb-3">
                <div class="stat-card fade-in">
                    ...
                    <div class="stat-footer"><span class="trend-up"><i class="bi bi-arrow-up"></i> 2 baru</span> menunggu verifikasi</div>
                </div>
            </div>
            <div class="col-lg-3 col-6 mb-3">
                <div class="stat-card fade-in">
                    ...
                    <div class="stat-footer"><span class="trend-up"><i class="bi bi-arrow-up"></i> 4 aktif</span> sedang diproses</div>
                </div>
            </div>
            <div class="col-lg-3 col-6 mb-3">
                <div class="stat-card fade-in">
                    ...
                    <div class="stat-footer"><span class="trend-up"><i class="bi bi-arrow-up"></i> 3</span> dalam perjalanan</div>
                </div>
            </div>
            <div class="col-lg-3 col-6 mb-3">
                <div class="stat-card fade-in">
                    ...
                    <div class="stat-footer"><span class="trend-up"><i class="bi bi-arrow-up"></i> 12</span> transaksi selesai</div>
                </div>
            </div>
        </div>
                    ...
                    <table class="table table-custom">
                        ...
                        <tbody>
                            <?php if (!empty($transaksi)): ?>
                                ...
                                <tr>
                                    <td><span class="font-weight-bold">#<?= $t['id_transaksi']; ?></span></td>
                                    <td>
                                    ...
                                    <td><span class="font-weight-bold" style="color:var(--roasted-brown);">Rp <?= number_format($t['grand_total'], 0, ',', '.'); ?></span></td>
                                    <td>
                                        <span class="status-badge <?= strtolower($t['status_pesanan']) == 'selesai' ? 'complete' : (strtolower($t['status_pesanan']) == 'pending' ? 'pending' : (strtolower($t['status_pesanan']) == 'dikirim' ? 'delivery' : (strtolower($t['status_pesanan']) == 'diproses' ? 'processing' : 'cancelled'))); ?>">
                                            <?= $t['status_pesanan']; ?>
                                        </span>
                                    </td>
                                    <td>
                                        <span class="status-badge <?= strtolower($t['status_bayar']) == 'lunas' ? 'complete' : (strtolower($t['status_bayar']) == 'batal' ? 'cancelled' : 'pending'); ?>">
                                            <?= $t['status_bayar']; ?>
                                        </span>
                                    </td>
                                    <td><?= $t['metode_bayar']; ?></td>
                                    <td><span style="font-size:0.8rem; color:var(--text-secondary);"><?= date('d/m/Y', strtotime($t['tanggal_transaksi'])); ?></span></td>
                                    <td class="text-center">
                                        <a href="<?= base_url('admin/transaksi/detail/' . $t['id_transaksi']); ?>"
                                           class="btn btn-sm"
                                           style="background:var(--amber-cream); color:white; border-radius:8px; padding:5px 12px; font-size:0.75rem; font-weight:600; transition:var(--transition-smooth);">
