...
<head>
    ...
    <title>Edit Mitra - Sistem Supply Chain Kopi</title>
...
<body>
    <div class="main-content" style="margin-left: 0; max-width: 800px; margin: 40px auto;">
        <h3 class="mb-4 font-weight-bold">Edit Mitra</h3>
        ...
        <div class="custom-card">
            <form action="<?= base_url('admin/mitra/edit/'.$mitra['id_mitra']); ?>" method="POST" enctype="multipart/form-data">
                
                <div class="form-group">
                    <label class="font-weight-bold text-secondary">Nama Mitra</label>
                    <input type="text" name="nama_mitra" class="form-control form-control-custom" value="<?= htmlspecialchars($mitra['nama_mitra']); ?>" required>
                </div>

                <div class="form-group">
                    <label class="font-weight-bold text-secondary">Kategori Mitra</label>
                    <input type="text" name="kategori_mitra" class="form-control form-control-custom" value="<?= htmlspecialchars($mitra['kategori_mitra']); ?>" required>
                </div>

                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label class="font-weight-bold text-secondary">Urutan Tampil</label>
                        <input type="number" name="urutan_tampil" class="form-control form-control-custom" value="<?= htmlspecialchars($mitra['urutan_tampil']); ?>" min="1" required>
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <div class="mb-2">
                            <img src="<?= base_url('assets/uploads/mitra/'.$mitra['logo_mitra']); ?>" alt="Logo Saat Ini" style="max-width: 100px; border-radius: 8px;">
                        </div>
                ...
                <div class="d-flex justify-content-end gap-2" style="gap: 10px;">
                    ...
                    <button type="submit" class="btn-custom-primary"><i class="bi bi-save mr-2"></i> Update Mitra</button>
                </div>
            </form>
        </div>
    </div>
