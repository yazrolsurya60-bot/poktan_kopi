...
<head>
    ...
    .btn-amber:hover {
        ...
        box-shadow: 0 4px 15px rgba(230, 161, 92, 0.3);
    }
    ...
    .payment-info-box table td {
        padding: 4px 8px;
    }

    .payment-info-box .bank-name {
        font-weight: 700;
    ...
    <div class="sidebar" id="sidebarMenu">
        ...
        <div class="sidebar-menu-wrapper">
            <ul class="sidebar-menu">
                ...
                <li class="menu-item">
                    <a href="<?= base_url('pembeli/tracking'); ?>"><i class="bi bi-geo-alt-fill"></i>Lacak
                        Pengiriman</a>
                </li>
                <li class="menu-item">
    ...
    <div class="main-content">
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <h2 class="d-inline-block align-middle mb-0">📄 Detail Transaksi
                    #<?= $transaksi['id_transaksi'] ?? 'N/A'; ?></h2>
                    ...
                    <div class="notif-dropdown" id="notifDropdown">
                        ...
                        <div class="notif-dropdown-list">
                            <div class="notif-item unread">
                                ...
                                <div class="notif-text">Pesanan #INV-2026-008 telah sampai tujuan <span
                                        class="notif-time">5 menit lalu</span></div>
                            </div>
                            <div class="notif-item unread">
                                <div class="notif-icon info"><i class="bi bi-truck"></i></div>
                                <div class="notif-text">Kurir sedang menuju lokasi Anda <span class="notif-time">15
                                        menit lalu</span></div>
                            </div>
                            <div class="notif-item">
                                <div class="notif-icon warning"><i class="bi bi-star-fill"></i></div>
                                <div class="notif-text">Anda mendapatkan 50 poin reward! <span class="notif-time">1 jam
                                        lalu</span></div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="custom-card">
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-7">
                                <?= date('d/m/Y H:i', strtotime($transaksi['tanggal_transaksi'] ?? date('Y-m-d H:i:s'))); ?>
                            </div>
                        </div>
                        <div class="row mb-2">
            ...
            <div class="col-md-6 mb-4">
                <div class="custom-card">
                    <div class="card-header-custom">
                        ...
                        <span class="badge"
                            style="background: var(--bg-cream); color: var(--text-secondary);"><?= count($details ?? []); ?>
                            item</span>
                    </div>
                            ...
                            <table class="table table-custom mb-0">
                                ...
                                <tfoot>
                                    <tr>
                                        ...
                                        <th class="text-right">Rp
                                            <?= number_format($transaksi['total_harga'] ?? $total_terhitung, 0, ',', '.'); ?>
                                        </th>
                                    </tr>
                                    <tr>
                                        <th colspan="2" class="text-right">Ongkir</th>
                                        <th class="text-right">Rp
                                            <?= number_format($transaksi['ongkir'] ?? 0, 0, ',', '.'); ?></th>
                                    </tr>
                                    <?php 
                                ...
                                ?>
                                    <tr style="border-top: 2px solid var(--amber-cream);">
                                        ...
                                        <th class="text-right"
                                            style="font-size:1.1rem; color: var(--amber-cream); font-weight:700;">
        ...
        <!-- ============================================================ -->
        <!-- 🔥 INFORMASI PEMBAYARAN (TANPA FORM UPLOAD)                  -->
        <!-- ============================================================ -->
        <div class="row">
            <div class="col-12">
                <div class="custom-card">
                    <div class="card-header-custom"
                        style="background: <?= $transaksi['status_bayar'] == 'Lunas' ? '#D1FAE5' : ($transaksi['status_bayar'] == 'Ditolak' ? '#FEE2E2' : '#FEF3C7'); ?>;">
                        <h6>
                    ...
                    <div class="card-body-custom">
                        ...
                        <div class="alert alert-warning instruction-alert">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-2">Silakan transfer sesuai dengan total pesanan Anda ke rekening
                                        berikut:</p>
                                    ...
                                    <div class="payment-info-box">
                                        <table class="table table-sm table-borderless mb-0">
                                            ...
                                            <tr>
                                                ...
                                                <td>: <span class="bank-name">123-456-7890</span></td>
                                            </tr>
                                            <tr>
                                    ...
                                    <small class="text-muted mt-2 d-block">
                                        ...
                                        Konfirmasi pembayaran akan diproses oleh admin dalam 1x24 jam setelah Anda
                                        transfer.
                                        <br>
                                        <i class="bi bi-info-circle mr-1"></i>
                                        Bukti transfer akan diverifikasi oleh admin melalui sistem.
                                    </small>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="alert alert-info instruction-alert">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Admin sedang memverifikasi bukti pembayaran Anda. Mohon tunggu
                                        sebentar.</p>
                                    <small class="text-muted mt-2 d-block">
                        ...
                        <div class="alert alert-success instruction-alert">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Pembayaran Anda telah dikonfirmasi oleh admin. Pesanan akan segera
                                        diproses.</p>
                                    <small class="text-muted mt-2 d-block">
                                        <i class="bi bi-truck mr-1"></i> Status pesanan akan berubah menjadi "Diproses"
                        ...
                        <div class="alert alert-danger instruction-alert">
                            <div class="d-flex align-items-start">
                                ...
                                <div>
                                    ...
                                    <p class="mb-0">Bukti pembayaran Anda ditolak oleh admin dengan alasan:</p>
                                    <div class="mt-2 p-2" style="background: rgba(239,68,68,0.1); border-radius:8px;">
                                        <em>"<?= $bukti['keterangan'] ?? 'Data tidak valid atau bukti tidak jelas. Silakan upload ulang dengan data yang benar.'; ?>"</em>
                                    </div>
                                    <small class="text-muted mt-2 d-block">
                                        <i class="bi bi-arrow-repeat mr-1"></i> Silakan hubungi admin untuk informasi
                                        lebih lanjut.
                                    </small>
                                </div>
                            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-md-6">
                                    ...
                                    <div class="font-weight-bold">
                                        <?= date('d/m/Y', strtotime($bukti['tanggal_transfer'] ?? date('Y-m-d'))); ?>
                                    </div>
                                </div>
                                <div class="col-md-6">
                                    <small class="text-muted">Jumlah Transfer</small>
                                    <div class="font-weight-bold">Rp
                                        <?= number_format($bukti['jumlah_transfer'] ?? 0, 0, ',', '.'); ?></div>
                                </div>
                                <?php if (!empty($bukti['file_bukti'])): ?>
                                <div class="col-12 mt-2">
                                    <a href="<?= base_url('uploads/bukti/' . $bukti['file_bukti']); ?>" target="_blank"
                        ...
                        <div class="mt-3 d-flex flex-wrap" style="gap:10px;">
                            ...
                            <a href="<?= base_url('pembeli/transaksi/invoice/' . $transaksi['id_transaksi']); ?>"
                        ...
                        <div class="mt-3 pt-3 border-top" style="border-color: rgba(74,44,17,0.08);">
                            <small class="text-muted">
                                <i class="bi bi-info-circle mr-1"></i>
                                <strong>Catatan:</strong> Bukti pembayaran akan diverifikasi oleh admin.
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header" style="border-bottom: none; padding-bottom: 0;">
                    <h5 class="modal-title" style="font-weight:700;"><i
                            class="bi bi-exclamation-triangle-fill text-danger mr-2"></i> Batalkan Pesanan</h5>
                    <button type="button" class="close" data-dismiss="modal">&times;</button>
                </div>
                <form action="<?= base_url('pembeli/transaksi/batalkan/' . ($transaksi['id_transaksi'] ?? '')); ?>"
                    method="POST">
