	...
	<div class="main-content">
			...
			<div class="col-lg-7 mb-4">
				<div class="custom-card">
					<div class="card-header-custom">
						...
						<span class="badge" style="background: #DBEAFE; color: #1E40AF; font-weight:500;"><?= $kpi_pesanan_dikirim ?? 0; ?> dalam perjalanan</span>
					</div>
					<div class="card-body-custom">
						...
						<div class="mt-3 d-flex justify-content-between align-items-center flex-wrap">
							<div>
								...
								<span class="status-badge shipped ms-2">Sedang Dikirim</span>
					...
					<div class="card-body-custom" style="padding: 16px 20px;">
								...
								<div class="rec-product-item">
									<div class="rec-product-img">
										<?php if (!empty($rec['foto'])): ?>
											<img src="<?= base_url('uploads/produk/' . $rec['foto']); ?>" alt="<?= $rec['nama_produk']; ?>" style="width:50px;height:50px;object-fit:cover;border-radius:10px;">
										<?php else: ?>
											<i class="bi bi-cup-hot"></i>
										<?php endif; ?>
									</div>
									<div class="rec-product-info">
										<div class="name"><?= $rec['nama_produk']; ?></div>
										<div class="price">Rp <?= number_format($rec['harga'], 0, ',', '.'); ?>/kg</div>
									</div>
									<a href="<?= base_url('landing/produk/detail/' . $rec['id_produk']); ?>" class="btn btn-sm"
						...
						<?php else: ?>
							<div class="text-center text-muted py-3">
								<p class="small mb-0">Belum ada rekomendasi produk</p>
							</div>
						<?php endif; ?>
					</div>
				</div>
		...
		<script>
			...
			function initChart() {
				...
				const chartData = <?= json_encode($grafik_belanja ?? ['labels' => ['Jan', 'Feb', 'Mar', 'Apr', 'Mei', 'Jun', 'Jul', 'Agu', 'Sep', 'Okt', 'Nov', 'Des'], 'values' => array_fill(0, 12, 0)]); ?>;
			...
			console.log('   - KPI Cards (Total Transaksi, Total Belanja, Pengiriman Aktif)');
			console.log('   - Tracking Peta');
