    ...
    <div class="main-content">
        ...
        <div class="page-header d-flex justify-content-between align-items-center flex-wrap">
            <div>
                ...
                <p class="subtitle mb-0 mt-1">Selamat datang, <span id="memberName"
                    ...
                    <span id="currentDateTime" style="color: var(--text-secondary); font-size:0.85rem;"></span></p>
            </div>
        ...
        <div class="row mb-4">
            <div class="col-lg-4 mb-4">
                <div class="stat-box"
                    style="background: linear-gradient(135deg, var(--roasted-brown), var(--dark-coffee)); border: none;">
                    ...
                    <h3 class="stat-num" style="color: white;"><?= number_format($kpi_poin ?? 2850, 0, ',', '.'); ?>
                        <small style="font-size: 1rem; font-weight:400; color: var(--amber-cream);">Poin</small></h3>
                    ...
                    <div class="d-flex justify-content-between mt-1">
                        ...
                        <span style="font-size:0.65rem; color: #A8988A;"><?= number_format(5000, 0, ',', '.'); ?> poin ke
                            level Gold</span>
                    </div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="stat-box">
                    ...
                    <div class="stat-change up"><i class="bi bi-arrow-up"></i> <?= $kpi_transaksi_naik ?? 2; ?> pesanan
                        baru</div>
            ...
            <div class="col-lg-4 mb-4">
                <div class="stat-box">
                    ...
                    <div class="stat-change up"><i class="bi bi-arrow-up"></i>
                        <?= number_format($kpi_belanja_naik ?? 1250000, 0, ',', '.'); ?> dari bulan lalu</div>
            ...
            <div class="col-lg-7 mb-4">
                <div class="custom-card">
                    <div class="card-header-custom">
                        ...
                        <span class="badge" style="background: #DBEAFE; color: #1E40AF; font-weight:500;"><?= $kpi_pesanan_dikirim ?? 2; ?>
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="notifTracking"
                            ...
                            <div class="col-md-3 col-6 mb-2">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="notifPoin"
                                        style="font-size:0.85rem;">Poin Reward</label>
                                </div>
                            </div>
                            <div class="col-md-3 col-6 mb-2">
                                <div class="custom-control custom-switch">
                            ...
                            <div class="col-md-6 col-6 mb-2">
                                <div class="custom-control custom-switch">
                                    ...
                                    <label class="custom-control-label" for="notifEmail"
                                        style="font-size:0.85rem;">Notifikasi via Email</label>
                                </div>
                            </div>
                        </div>
