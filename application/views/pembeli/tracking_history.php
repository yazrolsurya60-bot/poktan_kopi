        ...
        <div class="col-12">
            <div class="card">
                ...
                <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td><span class="status-badge <?= $track->status_class ?>"><i
                                                class="bi <?= $track->status_icon ?>"></i>
                                            <?= $track->status_label ?></span></td>
                                    <td><?= $track->nama_kurir ?: '-' ?></td>
                                    <td><?= date('d M Y', strtotime($track->created_at)) ?></td>
                                    <td><a href="<?= base_url('pembeli/tracking/detail/' . $track->id_tracking) ?>"
                                            class="btn btn-sm btn-info" style="border-radius:8px;"><i
                                                class="bi bi-eye"></i> Detail</a></td>
                                </tr>
                                <?php endforeach; ?>
                            </tbody>
                        </table>
                    ...
                    <?php endif; ?>
                    <a href="<?= base_url('pembeli/tracking') ?>" class="btn btn-secondary"
