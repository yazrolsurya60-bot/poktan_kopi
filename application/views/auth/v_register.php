...
=======
        ...
        .role-option input {
            position: absolute;
>>>>>>> 898444ee80c8fca8a7dfe7920e968d4692570e24
            opacity: 0;
...
<<<<<<< HEAD
        ...
        <div class="simulation-card">
            ...
            <a href="<?= base_url('auth/verify/' . $registerData['token']); ?>"
                class="btn btn-sm btn-primary text-white font-weight-bold"
                style="border-radius: 8px; background-color: #0284c7; border: none;">
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        <input type="text" name="nama" id="nama" class="form-control-custom"
                            placeholder="Masukkan nama lengkap Anda" value="<?= set_value('nama'); ?>" required>
                ...
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        <input type="email" name="email" id="email" class="form-control-custom"
                            placeholder="Masukkan email aktif" value="<?= set_value('email'); ?>" required>
