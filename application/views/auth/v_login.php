    ...
    <div class="login-container">
        ...
        ?>
            <div class="simulation-card">
                ...
                <a href="<?= base_url('auth/verify/' . $verifyData['token']); ?>" class="btn btn-sm btn-info text-white font-weight-bold" style="border-radius: 8px;">
            ...
            <form method="POST" action="<?= base_url('auth/login'); ?>">
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        <input type="text" name="username_or_email" id="username_or_email" class="form-control-custom" placeholder="Masukkan username atau email" value="<?= set_value('username_or_email'); ?>" required>
