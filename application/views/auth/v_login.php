            ...
            <form method="POST" action="<?= base_url('auth/login'); ?>">
                <div class="form-group">
                    ...
                    <div class="input-group-custom">
                        <input type="text" name="username_or_no_telepon" id="username_or_no_telepon" class="form-control-custom" placeholder="Masukkan username atau no. telepon" value="<?= set_value('username_or_no_telepon'); ?>" required>
